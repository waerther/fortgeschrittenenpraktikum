...
Bereits aus der Wellendynamik, beispielsweise von Wasserwellen, ist bekannt, dass diese sich überlagern können und so auch auslöschen können.
Damit können prinzipiell auch Lichtwellen miteinander interferieren und sich auslöschen.
Dafür muss das Licht aber einige Eigenschaften erfüllen.
Dazu zählt die \textbf{Kohärenz}.
Kohärentes Licht beschreibt Licht mit fester Frequenz, Phase und Ausbreitungsrichtung.
So ein Licht wird beispielsweise von Lasern hergestellt.
